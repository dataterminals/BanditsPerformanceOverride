...
local function ManageActionState(bandit)
    ...
    local actions = {
        ...
        ["onground"] = function() Bandit.ClearTasks(bandit); return false end,
        ["onground-ragdoll"] = function() Bandit.ClearTasks(bandit); return false end,
        ["onground-breathing"] = function() Bandit.ClearTasks(bandit); return false end,
        ["falldown"] = function() Bandit.ClearTasks(bandit); return false end,
        ["falldown-headleft"] = function() Bandit.ClearTasks(bandit); return false end,
        ["falldown-headleft-ragdoll"] = function() Bandit.ClearTasks(bandit); return false end,
        ["falldown-headright"] = function() Bandit.ClearTasks(bandit); return false end,
        ["falldown-headright-ragdoll"] = function() Bandit.ClearTasks(bandit); return false end,
        ["falldown-tophead"] = function() Bandit.ClearTasks(bandit); return false end,
        ["falldown-tophead-ragdoll"] = function() Bandit.ClearTasks(bandit); return false end,
        ["falldown-knifedead"] = function() Bandit.ClearTasks(bandit); return false end,
        ["falldown-knifedead-ragdoll"] = function() Bandit.ClearTasks(bandit); return false end,
        ["falldown-onknees"] = function() Bandit.ClearTasks(bandit); return false end,
        ["falldown-onknees-ragdoll"] = function() Bandit.ClearTasks(bandit); return false end,
        ["falldown-ragdoll"] = function() Bandit.ClearTasks(bandit); return false end,
        ["falldown-speardeath1"] = function() Bandit.ClearTasks(bandit); return false end,
        ["falldown-speardeath1-ragdoll"] = function() Bandit.ClearTasks(bandit); return false end,
        ["falldown-speardeath2"] = function() Bandit.ClearTasks(bandit); return false end,
        ["falldown-speardeath2-ragdoll"] = function() Bandit.ClearTasks(bandit); return false end,
        ["falldown-uppercut"] = function() Bandit.ClearTasks(bandit); return false end,
        ["falldown-uppercut-ragdoll"] = function() Bandit.ClearTasks(bandit); return false end,
        ["hitreaction"] = function() Bandit.ClearTasks(bandit); return false end,
        ["hitreaction-fencewindow"] = function() Bandit.ClearTasks(bandit); return false end,
        ["hitreaction-fencewindow-ragdoll"] = function() Bandit.ClearTasks(bandit); return false end,
        ["hitreaction-gettingup"] = function() Bandit.ClearTasks(bandit); return false end,
        ["hitreaction-hit"] = function() Bandit.ClearTasks(bandit); return false end,
        ["hitreaction-onfloor"] = function() Bandit.ClearTasks(bandit); return false end,
        ["hitreaction-ragdoll"] = function() Bandit.ClearTasks(bandit); return false end,
        ["hitreaction-shothead-bwd"] = function() Bandit.ClearTasks(bandit); return false end,
        ["hitreaction-shothead-bwd-ragdoll"] = function() Bandit.ClearTasks(bandit); return false end,
        ["hitreaction-shothead-fwd"] = function() Bandit.ClearTasks(bandit); return false end,
        ["hitreaction-shothead-fwd-ragdoll"] = function() Bandit.ClearTasks(bandit); return false end,
        ["hitreaction-shothead-fwd02"] = function() Bandit.ClearTasks(bandit); return false end,
        ["hitreaction-shothead-fwd02-ragdoll"] = function() Bandit.ClearTasks(bandit); return false end,
        ["knockeddown-headleft"] = function() Bandit.ClearTasks(bandit); return false end,
        ["knockeddown-headright"] = function() Bandit.ClearTasks(bandit); return false end,
        ["knockeddown-headtop"] = function() Bandit.ClearTasks(bandit); return false end,
        ["knockeddown-shotchestl"] = function() Bandit.ClearTasks(bandit); return false end,
        ["knockeddown-shotchestr"] = function() Bandit.ClearTasks(bandit); return false end,
        ["knockeddown-shotlegl"] = function() Bandit.ClearTasks(bandit); return false end,
        ["knockeddown-shotlegr"] = function() Bandit.ClearTasks(bandit); return false end,
        ["knockeddown-shotshoulderl"] = function() Bandit.ClearTasks(bandit); return false end,
        ["knockeddown-shotshoulderr"] = function() Bandit.ClearTasks(bandit); return false end,
        ["knockeddown-uppercut"] = function() Bandit.ClearTasks(bandit); return false end,
        ["staggerback"] = function() Bandit.ClearTasks(bandit); return false end,
        ["staggerback-knockeddown"] = function() Bandit.ClearTasks(bandit); return false end,
        ["staggerback-knockeddown-frombehind"] = function() Bandit.ClearTasks(bandit); return false end,
        ["staggerback-knockeddown-ragdoll"] = function() Bandit.ClearTasks(bandit); return false end,
        ["staggerback-ragdoll"] = function() Bandit.ClearTasks(bandit); return false end,
        ["vehiclecollision-bumped"] = function() Bandit.ClearTasks(bandit); return false end,
        ["vehiclecollision-falldown"] = function() Bandit.ClearTasks(bandit); return false end,
        ["vehiclecollision-onground"] = function() Bandit.ClearTasks(bandit); return false end,
        ["vehiclecollision-onground-dead"] = function() Bandit.ClearTasks(bandit); return false end,
        ["vehiclecollision-ragdoll"] = function() Bandit.ClearTasks(bandit); return false end,
        ["vehiclecollision-staggerback"] = function() Bandit.ClearTasks(bandit); return false end,
    }
